...
<img width="867" height="95" alt="image" src="https://github.com/user-attachments/assets/648a5744-320d-4f00-8e58-05febb498763" />

This learning path covers the core technical skills that will allow you to succeed as a junior penetration tester. 

Upon completing this path am looking forwad to gaining practical skills necessary to perform security assessments against web applications and enterprise infrastructure.


---

## 2026 version of the JR. PENETRATION TESTER

===============================================
===============================================
=>Starting the Cybersec Journey
...
03. Protocols and Servers
04. Protocols and Servers 2

=============================================

=> Nmap
01. Nmap Live Host Discovery 
02. Nmap Basic Port Scans
03. Nmap Advanced port scans
...
=> Burp suite
01. Burp Suite: The Basics
02. Burp Suite: Repeater
03. Burp Suite: Intruder
04. Burp Suite: Other Modules
05. Burp Suite: Extensions
